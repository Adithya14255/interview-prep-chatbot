...
A sleek, AI-powered Streamlit application that provides **interactive interview simulation** for job seekers. Practice with a virtual interviewer who asks questions one by one, provides feedback, and gives comprehensive performance evaluation.
